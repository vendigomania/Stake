...
namespace GTranslatorAPI
{
    ...
    public static class LanguagesUtil
    {
        ...
        static public Languages? GetLanguageCodeFromLanguageName(string languageName)
        {
            var map = GetLanguagesCodesToNames();
            return map.First((kvp) => kvp.Value == languageName).Key;
        }
